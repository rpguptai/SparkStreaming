package com.versh.structureStreaming
...
import com.versh.streamingex.Utilities._
...
object StructuredStreaming {
   ...
   def main(args: Array[String]) {
      ...
      val rawData = spark.readStream.text("C:\\work\\BIG_D\\workspace\\spScalaStream\\data\\logs")
