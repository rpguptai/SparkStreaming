  ...
  def main(args: Array[String]) {
    ...
    statuses.foreachRDD((rdd, time) => {
      ...
      if (rdd.count() > 0) {
        ...
        //repartitionedRDD.saveAsTextFile("C:\\work\\BIG_D\\workspace\\spScalaStream\\data\\twit\\"+"Tweets_" + time.milliseconds.toString)
        rdd.saveAsTextFile("C:\\work\\BIG_D\\workspace\\spScalaStream\\data\\twit\\"+"Tweets_" + time.milliseconds.toString)
